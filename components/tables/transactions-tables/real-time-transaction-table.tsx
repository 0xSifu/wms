            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  toast({
                    title: "Success",
                    description: `Created ${selectedRows.length} transaction${selectedRows.length > 1 ? 's' : ''} successfully`,
                  });
                } catch (error) {
              ...
              <tr key={id} className="border-b">
                <td className="h-12 px-4">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleRowSelect(transaction, checked as boolean)}
                  />
                </td>
